...
class DocumentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create document_type" do
    assert_difference('DocumentType.count') do
      post document_types_url, params: { document_type: { descripcion: @document_type.descripcion, fecha_creacion: @document_type.fecha_creacion, id: @document_type.id } }
    end
  ...
  test "should update document_type" do
    patch document_type_url(@document_type), params: { document_type: { descripcion: @document_type.descripcion, fecha_creacion: @document_type.fecha_creacion, id: @document_type.id } }
